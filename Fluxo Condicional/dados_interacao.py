...
##pais dos usuários com mais de 30 anos
paises = []
...
for dado_de_usuario in propaganda_online:
    try:
        ...
        ##print('Erro: ' + str(exc))
        ##print('Tipo: ' + str(type(exc)))  /// ERROR - KEYERROR (Falta do item 'clicou_no_ad' em uma das colunas)
        dado_de_usuario['clicou_no_ad'] = 0  # Adiciona o valor faltante
    finally:
        if dado_de_usuario['clicou_no_ad'] == 0 and dado_de_usuario['renda_area'] not in leads:
            leads.append(dado_de_usuario['renda_area'])
print(leads)
